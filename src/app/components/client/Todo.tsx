      ...
      <div className="mx-2 my-2 shadow-xl card bg-base-100">
        <div className="card-body">
          <div className="flex items-center gap-4">
            ...
            { !isLoading && (
              <input type="checkbox" disabled={isDisabled} onClick={isDisabled ? ()=>{} : handleTodo} checked={todo.is_complete === true ? true : false} className="col-span-1 px-2 checkbox checkbox-primary checkbox-lg" />
            )}
